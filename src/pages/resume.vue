...
<Layout>
    ...
    <section>
      <div>
        <div><img src="../../static/intern.jpg" alt="avatar" class="avatar"></div>
      </div>
      <div>
        <div class="my-name">Uchechukwu Chidiebere</div>
        ...
        <div class="links">
          <div class="link-item">
            ...
            <a href="http://google.ca">jakeuche.com</a>
          </div>
          <div class="link-item">
            ...
            <a href="mailto:uchechidi9@gmail.com">uchechidi9@gmail.com</a>
          </div>
          <div class="link-item">
            ...
            <a href="tel:+2348102353377">+2348102353377</a>
          </div>
        </div> <!-- end links -->
      ...
      <div>
        <div class="job">
          <div class="job-title-container">
            <div>
              <div class="job-company">Jake Uche</div>
              <div class="job-title">Freelance Web Developer / Designer
</div>
            </div>
            <div>
              Jan 2019 - Present
          ...
          <p>I design and develop websites and web applications to meet the business requirements of my clients. Every client is different so my work ranges from basic static websites to more complex web applications. Have a look at my online portfolio/website for examples of client work, code samples and testimonials.</p>
        </div> <!-- end job -->

        <div class="job">
          <div class="job-title-container">
            <div>
              <div class="job-company">HIIT</div>
          ...
          <p>Worked on several projects ranging from Node.js sites, Vue js and Ionic mobile applications. Responsibilities included implementing new features, fixing existing bugs, co-ordinating with other developers and project managers, improving code quality, improving technology stacks and delvering the needs of our clients..</p>
        </div> <!-- end job -->

        <div class="job">
          <div class="job-title-container">
            <div>
              <div class="job-company">Mecure Health care</div>
              <div class="job-title">Intership</div>
            </div>
            <div>
              June 2017 - Dec 2018
            </div>
          </div> <!-- end job-title container -->
          <p>Worked with a team of developers to update and
maintain our medical mobile app software (MeCure -
Smart)</p>
<p>Assisted in computer maintenance (sample accreditation
/ dispatch unit)
</p>
        </div> <!-- end job -->
      </div>
    ...
    <section>
      ...
      <div>
        <div class="job">
          <div class="job-title-container">
            <div>
              <div class="job-company">FEDERAL UNIVERSITY OF TECHNOLOGY OWERRI</div>
              <div class="job-title">Bachelors of Technology in Biological science  Field</div>
            </div>
            <div>
              Nov 2013 - Nov 2018
            </div>
          </div> <!-- end job-title container -->
          <!-- <p>Bachelors of Technology in Biological science  Field</p> -->
        </div> <!-- end job -->
      </div>
    </section>
    ...
    <section>
      ...
      <div>
        <div class="skills-container">
          <ul>
            <li>Node js</li>
            <li>Ionic Frame work</li>
            <li>Capacitor.js</li>
            <li>Apache Cordovar</li>
          </ul>
        ...
        <p>A good problem solver as required and quite rightfull so.</p>
      </div>
    </section>
    ...
    <section>
      ...
      <div>
        <div class="job-company">Will Be Provided on request</div>
