  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-blue-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><g-image src="../../static/NICONNET.png" class="w-40 logo-img" alt="logo" /></g-link>
          <g-link v-else to="/"><g-image src="../../static/NICONNET.png" class="w-40" alt="logo" /></g-link>
        </div>
        ...
        >
          ...
          <li>
           ...
           <li>
            ...
            <g-link to="/resume" class="text-copy-primary hover:text-gray-600" data-cypress>Resume</g-link>
          </li>
          <li>
    ...
    <footer class="bg-green-700 text-white footer-background">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:uchechidi9@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/jakesuche" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/jake_nicon" target="_blank" class="text-white hover:text-gray-400">
...
.border-t-14 {
    ...
    border-top: 14px #2c88d3d1 solid;
}
